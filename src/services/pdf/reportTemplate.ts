...
${pv(content, 3, 'opinion-of-probable-cost') ? `<p>${pv(content, 3, 'opinion-of-probable-cost')}</p>` : '<p>Based on the walk-through of the Subject Property, interviews conducted and information obtained while conducting this PCA, NDDS\'s opinion of the probable cost to address areas of physical deficiency or deferred maintenance, that would be considered outside the normal on-going routine maintenance of a property, are provided in Table 1 in Appendix C of this report.</p>'}
...
<ol>
  <li><strong>Poor</strong> &ndash; not in working condition or requires immediate or short term repairs substantially above an agreed threshold;</li>
  <li><strong>Fair</strong> &ndash; in working condition, but may require immediate or short repairs above an agreed threshold;</li>
  <li><strong>Good</strong> &ndash; in working condition and does not require immediate or short term repairs above an agreed threshold</li>
</ol>

<p><strong>Immediate Term (0-90 Days)</strong> - Opinions of Costs that require immediate action as a result of any of the following: (1) represent an imminent life-safety issue, (2) material building or fire code violations, or (3) conditions that if left unremedied, have the potential to result in or contribute to critical element or system failure</p>

<p><strong>Short Term (0-1 Year)</strong> - Opinions of Costs to remedy physical deficiencies, such as deferred maintenance, that may not warrant immediate attention, but require repairs or replacements that should be undertaken on a priority basis in addition to routine preventative maintenance. Such Opinions of Costs may include costs for further testing, exploratory, and/or investigation that are beyond the scope of this Report.</p>
...
<ul>
  <li><strong>Property/Site Features:</strong> Observations will be made of the type, condition and adequacy of the general topography, storm water drainage, ingress and egress, paving, curbing and parking areas, flatwork, landscaping and appurtenances, recreation facilities, amenities and ancillary structures, and utilities.</li>
  <li><strong>Structural Frame and Building Envelope:</strong> Observations will be made of the type, condition and adequacy of the foundation, building frame, fa&ccedil;ade and curtain walls, and the roofing systems.</li>
  <li><strong>Mechanical, Electrical and Plumbing Systems:</strong> Observations will be made of the type, condition and adequacy of the heating, ventilation and air conditioning (HVAC) systems, electrical systems and plumbing systems.</li>
  <li><strong>Vertical Transportation:</strong> Observations will be made regarding the presence and condition of any elevators or escalators present on the property.</li>
  <li><strong>Life Safety/Fire Protection:</strong> Observations will be made of the type, condition and adequacy of sprinkler systems, fire alarm systems or any other life safety and fire protection systems.</li>
  <li><strong>Interior Elements:</strong> Observations will be made of the type, condition and adequacy of the interior finishes, fixtures, appliances and furnishings.</li>
  <li><strong>Accessibility:</strong> Depending on the applicability of the regulations, a Tier I Visual Survey will be conducted to determine if the property is in compliance with the Americans with Disabilities Act (ADA) or the Fair Housing Act (FHA).</li>
</ul>

<p><strong>Opinions of Probable Costs to Remedy Physical Deficiencies:</strong> Based on the documentation review, interviews and walk-through survey conducted, NDDS will identify areas of physical deficiency and deferred maintenance.</p>

<p>NDDS will also generate a Capital Replacement Reserve Schedule. Capital replacement Reserves are for recurring probable expenditures that are not classified as operation or maintenance expenses.</p>

<h3 id="section-2-3">2.3&nbsp;&nbsp;&nbsp;Limitations and Exceptions</h3>

<ul>
  <li>The scope of work completed was designed solely to meet the needs of NDDS's Client. NDDS's recommendations and opinions of cost are only as of the date the walk-through performed, documentation reviewed and interviews conducted. Conditions at a property and the costs to remedy them can change significantly over a relatively short period of time due to levels of maintenance, acts of nature and other factors.</li>
  <li>No PCA can wholly eliminate uncertainty regarding the potential for physical deficiencies and the performance of a property's building. There is an inherent subjective nature of opinions as to such issues as workmanship, quality of original installation, and estimating the RUL of any given component or system.</li>
  <li>The PCA is intended to be a non-intrusive assessment. No destructive testing was completed and concealed areas, such as inside plenums, behind walls or within machinery, were not accessed.</li>
  <li>This PCA does not constitute a regulatory or code compliance audit of the building systems of management systems that may be present at the Subject Property.</li>
  <li>Information in this report, concerning past and current physical concerns, maintenance and replacement activities, and condition of spaces not observed or viewable, is from sources deemed to be reliable; however, no representation or warranty is made as to the accuracy thereof.</li>
  <li>While the general environmental setting of the property is described, this assessment is not intended to be a formal flood plain or wetland determination, and no warranty is made thereof.</li>
  <li>While a complete archive of photographs taken during the site visit is provided for reference, the consultant does not warrant that all conditions visible in those photographs were observed, assessed, or deemed relevant to the scope of this assessment.</li>
</ul>
...
${pv(content, 8, 'special-utility-notes') ? `<p>${pv(content, 8, 'special-utility-notes')}</p>` : '<p>No deficiencies or Special Utility Systems were observed or reported.</p>'}
