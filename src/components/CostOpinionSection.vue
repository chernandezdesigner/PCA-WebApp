        ...
        <TransitionGroup name="list" tag="div" class="space-y-1.5">
          ...
          >
            ...
            <input
              ...
              class="w-full px-3 py-2 rounded-lg text-sm shadow-sm transition-all duration-150 text-right tabular-nums focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              :class="inputClass"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div v-for="field in config.reserveFields" :key="field.id">
            ...
            <input
              ...
              :disabled="disabled"
              class="w-full px-4 py-2.5 rounded-lg text-sm shadow-sm transition-all duration-150 tabular-nums focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              :class="inputClass"
